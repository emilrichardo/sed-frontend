...
export function EntriesTable({
  ...
  return (
    <div className="bg-white rounded-xl border border-neutral-200 shadow-sm overflow-hidden flex flex-col h-full ring-1 ring-black/5">
      {/* Header */}
      <div className="px-6 py-4 border-b border-neutral-100 bg-white flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <span className="px-2 py-0.5 rounded-full bg-neutral-100 text-neutral-500 text-[10px] font-extrabold uppercase tracking-tight">
            {data.length} TOTAL
          </span>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <ToggleGroup.Root
            ...
            className="flex bg-neutral-100 p-1 rounded-lg border border-neutral-200 shadow-inner"
            aria-label="Modo de visualización"
          >
            <ToggleGroup.Item
              value="table"
              className={cn(
                "p-1.5 rounded-md transition-all outline-none focus:ring-2 focus:ring-indigo-500/20",
                viewMode === "table"
          ...
          <Separator.Root
            ...
            className="w-px h-6 bg-neutral-200 mx-2 hidden sm:block"
          />
          ...
          <div className="flex items-center gap-2">
            ...
            {onProcessAll && (
              <Button
                ...
                className="gap-2 font-bold bg-indigo-600 hover:bg-indigo-700 h-8 shadow-sm"
              >
        ...
        <div className="px-6 py-4 bg-neutral-50 border-b border-neutral-100 animate-in slide-in-from-top-2 duration-200">
          <div className="relative">
            ...
            <Input
              ...
              className="pl-10 pr-10 py-2 h-9 border-neutral-200 focus-visible:ring-indigo-500/20 focus-visible:border-indigo-500 shadow-none bg-white"
              value={searchQuery}
        ...
        <ScrollArea.Viewport className="h-full w-full rounded-none">
          {isLoading ? (
            ...
            <table className="w-full text-left border-collapse min-w-[600px]">
              <thead className="sticky top-0 bg-neutral-100/95 backdrop-blur-sm z-10 border-b border-neutral-200 shadow-sm">
