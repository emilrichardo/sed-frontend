...
export function CreateNewsButton() {
  ...
  return (
    <button
      ...
      disabled={isCreating}
      className="bg-primary text-primary-foreground px-4 py-2 font-medium disabled:opacity-50 flex items-center gap-2 rounded-md hover:bg-primary/90 shadow-sm transition-all"
    >
      {isCreating ? (
        "Creando..."
      ) : (
