...
const STATIC_WIDGETS: WidgetDoc[] = [
  ...
  {
    id: -3,
    titulo: "Finanzas Provinciales",
    descripcion: "Comparación mensual y anual entre coparticipación federal e ingresos propios.",
    slug: "widget-fiscal",
    tipo_fuente: "estatico",
    tabla_relacionada: null,
    tipo_visualizacion: "",
    config_viz: {},
    nombre_widget: "WidgetFiscal",
    nombre_widget_custom: null,
    coleccion: null,
    modo_seleccion: "",
    cantidad: 0,
